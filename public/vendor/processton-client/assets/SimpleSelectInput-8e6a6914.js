import { j as jsxRuntimeExports, r as reactExports, d as React, b as reactDomExports } from "./app-7ef8dedc.js";
import { c as classNames$1 } from "./AppLayout-d617927c.js";
...
function InputLabel({ label = "", required = false, className = "", htmlFor = "", children = /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {}), ...props }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { ...props, className: `block font-medium text-sm text-gray-700 ` + className, htmlFor, children: [
    label ? label : children,
    " ",
    required === true && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "*" })
  ] });
}
const TextInput = reactExports.forwardRef(function TextInput2({ map, className = "", isFocused = false, value = "", disabled = false, ...props }, ref) {
...
function DummyInput(_ref3) {
  var innerRef = _ref3.innerRef, props = _objectWithoutProperties(_ref3, _excluded$1);
...
const SelectInput = reactExports.forwardRef(function SelectMultipleInput({ options: options2, className = "", value, isFocused = false, placeholder = "", ...props }, ref) {
...
export {
  ...
  _slicedToArray as I,
  handleInputChange as J,
  _objectSpread2 as K,
  _defineProperty as L,
  useStateManager as M,
  _extends as N,
  InputLabel as O,
  SelectInput as P,
  Select as S,
  ...
  createCoords as s,
  getWindow as t,
  getComputedStyle$1 as u,
  getDocumentElement as v,
  isHTMLElement as w,
  round as x,
  isWebKit as y,
  floor as z
