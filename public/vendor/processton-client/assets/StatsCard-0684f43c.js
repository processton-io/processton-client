import { e as getAugmentedNamespace, r as reactExports, j as jsxRuntimeExports } from "./app-7ef8dedc.js";
import { c as classNames, A as AppIcon } from "./AppLayout-d617927c.js";
/* empty css              */var build = {};
var t = function() {
...
function StatsCard(props) {
  ...
  switch (type) {
    case "simple_dual":
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleDualStatsCard, { title, value: formatNumber(value), icon, unit, unit_2, value_2: formatNumber(value_2), seperator });
    default:
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleStatsCard, { title, value: formatNumber(value), icon, unit });
  }
}
function SimpleStatsCard({ title, value, icon, unit }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full p-0 m-0 bg-white border h-full flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 break-words my-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-auto p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pr-4 flex-1 flex-grow flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: classNames("text-primary uppercase font-bold", {
        " text-xs": icon,
        " text-lg": !icon
      }), children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: icon && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-4xl text-blueGray-700 text-left", children: [
        ...
        " ",
        unit && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: unit })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-auto pl-4 flex-shrink", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white p-3 text-center inline-flex items-center justify-center w-14 h-14  rounded-full bg-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppIcon, { icon }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: !icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-auto pl-4 flex-initial", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-0 text-center inline-flex items-right justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-4xl text-blueGray-700", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        _default,
        {
          end: value.value,
...
function SimpleDualStatsCard({ title, value, value_2, seperator, icon, unit, unit_2 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full p-0 m-0 bg-white border h-full flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0 break-words my-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-auto p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative pr-4 w-full xs:w-7/12 flex-grow flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: classNames("text-primary uppercase font-bold", {
        " text-xs": icon,
        " text-lg": !icon
      }), children: title }),
      icon && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-2 pt-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("sup", { className: "font-semibold text-4xl text-blueGray-700 text-right", children: [
          value.value,
          " ",
          value.suffix,
          " ",
        ...
        seperator && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl font-light text-blueGray-400 px-1", children: seperator }),
        value_2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("sub", { className: "font-semibold text-4xl text-blueGray-700 text-right", children: [
          value_2.value,
          " ",
          value_2.suffix,
          " ",
          unit_2 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: unit_2 })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-auto pl-4 flex-shrink", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white p-3 text-center inline-flex items-center justify-center w-12 h-12  rounded-full bg-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppIcon, { icon }) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: !icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-auto pl-4 flex-initial", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-0 py-3 pb-2 text-center inline-flex items-right justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("sup", { className: "font-semibold text-4xl text-blueGray-700", children: [
        value.value,
        " ",
        value.suffix,
        " ",
      ...
      seperator && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl font-light text-blueGray-400", children: seperator }),
      value_2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("sub", { className: "font-semibold text-4xl text-blueGray-700", children: [
        value_2.value,
        " ",
        value_2.suffix,
        " ",
