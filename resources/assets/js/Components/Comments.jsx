...
export default function Comments({ comments }) {
    ...
    return (
            <div className="bg-white rounded-sm p-4">
                ...
                <form className="mb-6">
                    <div className="py-2 px-4 mb-4 bg-white rounded-sm rounded-t-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                        <label for="comment" className="sr-only">Your comment</label>
                        <textarea id="comment" rows="3"
                            className="px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 dark:bg-gray-800"
                            placeholder="Write a comment..." required></textarea>
                    </div>
                    <ActionButton type="primary"  label="Post Comment" />
                </form>
...
const CommentsWrapper = ({ comments }) => {
    return <section className="bg-white dark:bg-gray-900 py-0 antialiased">
...
const Comment = ({ comment }) => {
    return <article className="p-4 text-base bg-white rounded-lg dark:bg-gray-900">
